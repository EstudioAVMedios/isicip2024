                    ...
                    <div class="dtr-header-right ml-auto">
                        <div class="main-navigation dtr-menu-light">
                            <ul class="sf-menu dtr-scrollspy dtr-nav light-nav-on-load dark-nav-on-scroll sf-js-enabled sf-arrows dtr-menu-light"
                                ...
                                <li> <a class="nav-link px-1 py-1  active2 active" href="contact.php">Contact</a> </li>
                                <li>
                                    <div class="dropdown">
                        ...
                        <div class="dtr-sticky-tabs-content">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <!-- column 1 starts -->
                                    <div class="col-12 col-md-6" style="text-align: right"> <img
                                            src="../assets/images/logo_secretaria.png" alt="image"
                                            style="text-align: right" class="w-75"> </div>
                                    <!-- column 1 ends -->
                                    ...
                                    <div class="col-12 col-md-6 small-device-space">
                                        ...
                                        <ul class="border-left px-5" style="list-style: none">
                                            <li>Cero3- Corporate Event Management</li>
                                            <li>Marketing Solutions & Health Meetings</li>
                                            <li> eventos03@cerotreseventos.es</li>
                                            <li> +34 91 737 37 31</li>
                                        </ul>
                                    </div>
                                </div>
                                <!-- column 2 ends -->
...
================================================== -->
            ...
            <div class="modal fade" id="Modalletter" tabindex="-1" aria-labelledby="ModalLabelletter"
                aria-hidden="true">
                <div class="modal-dialog modal-xl modal-dialog-scrollable">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body"> <img src='../assets/images/program/welcome.png' class="w-100"> </div>
