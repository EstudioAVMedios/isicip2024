...
$('#login').on('click', function(){
	var datos= new FormData(document.getElementById('login_form'));
	$.ajax({
		...
		success:function(res){
			if($.trim(res)=="email"){
			   $('#alert').fadeIn();
				...
				$('#alert').fadeIn().text('La contraseña introducida no es correcta, iténtelo de nuevo o cambie su contraseña.');   
			   }else if($.trim(res)=="ok"){
