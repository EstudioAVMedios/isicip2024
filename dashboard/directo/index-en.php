...
<body onclick="bPreguntar = true;">
        ...
        <div class="d-flex w-100 align-content-center">
            ...
            <div class="ms-auto" id="navbarSupportedContent">
                ...
                <div class="border-end border-start h-100 ms-auto" id="out">
                    ...
                    <a class="nav-link p-3" aria-current="page" href="#" style="color: <?php echo $evento['COLOR'] ?>" data-bs-toggle="modal" data-bs-target="#exampleModal3"><i class="fas fa-sign-out-alt"></i></a>
    ...
    <!---VIMEO---------------->
    <div style="padding:45.25% 0 0 0;position:relative; width: 80%; height: auto; vertical-align: top" class="d-inline-block" id="video"><iframe src="https://vimeo.com/event/4073397/embed/interaction" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>
    <div class="h-100 d-inline-block text-center" style="vertical-align: top; width: 19%; color:rgb(136, 136, 136)" id="chat_general">
...
----->
        ...
        <div class="d-flex" id="button">
            <a href='index.php' class="ms-3"><button class="btn py-1 ms-auto m-2" style="background:<?php echo $evento['COLOR'] ?>; color: white; font-size: 14px;"><i class="far fa-play-circle"></i> Español - Castellano </button></a>
            <button class="btn py-1 ms-auto m-2" style="background:<?php echo $evento['COLOR'] ?>; color: white; font-size: 14px;" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class="fas fa-plus-circle"></i> Hacer
                Pregunta</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn" style="background: <?php echo $evento['COLOR'] ?>; color:white" id="send_question" data-bs-dismiss="modal">Enviar</button>
  ...
  Launch demo modal
    ...
    <div style="background:black; width: 100%; height: 100%;z-index: 1; position: absolute;top: 0; opacity: 0.7;display: none" id="fondo_modal"></div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary border-0" data-bs-dismiss="modal" id="presente" style="background: <?php echo $evento['COLOR'] ?>;">Seguir viendo <i class="far fa-play-circle"></i></button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn text-white" style="background: <?php echo $evento['COLOR'] ?>;" id="salir">Salir</button>
